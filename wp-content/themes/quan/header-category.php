...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/linea-ecommerce/styles.css" media="all" />
    <link rel="stylesheet" type="text/css" href="css/elegantIcons/elegantIcons.min.css" media="all" />
    <link rel="stylesheet" type="text/css" href="css/owl.carousel.css" media="all" />
    <link rel="stylesheet" type="text/css" href="css/slick.css" media="all" />
    <link rel="stylesheet" type="text/css" href="css/arw-styles.css" media="all" />
    <link rel="stylesheet" type="text/css" href="css/arw-custom-class.css" media="all" />
    <link rel="stylesheet" type="text/css" href="css/arw-extension.css" media="all" />
    <link rel="stylesheet" type="text/css" href="css/arw-responsive.css" media="all" />
    ...
    <script type="text/javascript" src="js/product-media.js"></script>
    <script type="text/javascript" src="js/swatches-list.js"></script>
    <script type="text/javascript" src="js/theme.1.9.1.js"></script>
...
<script type="text/javascript" src="http://m2.arexmage.com/arw_dots/js/arw/filter/URI.min.js"></script>
<script type="text/javascript" src="http://m2.arexmage.com/arw_dots/js/arw/filter/filter.js"></script>
<body class=" catalog-category-view categorypath-tv-video-html category-tv-video layout-stretched header-skin-1">
    <!-- navigation BOF -->
